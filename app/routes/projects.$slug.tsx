        ...
        <div className="min-h-screen bg-background pt-32 pb-20 px-6 md:px-12 lg:px-24 cursor-auto selection:bg-zinc-800 selection:text-white dark:selection:bg-white dark:selection:text-black">
            ...
            <div className="fixed top-6 left-6 md:left-12 z-50">
                <Magnetic strength={0.2}>
                    <Link to="/" className="flex items-center gap-2 px-5 py-2.5 bg-background/80 backdrop-blur-md border border-border rounded-full text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/20 transition-all shadow-xl hover:scale-105 active:scale-95 group">
            ...
            >
                {project.imageUrl ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-muted-foreground font-display text-4xl md:text-6xl font-bold tracking-tighter opacity-50" style={{ backgroundColor: project.imageColor }}>
                        {project.title}
                    </div>
                )}
            </motion.div>
            ...
            <div className="max-w-5xl mx-auto mb-40 border-t border-border pt-16">
                <h3 className="text-xs font-mono text-muted-foreground mb-12 uppercase tracking-widest">Tech Stack</h3>
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center justify-center pb-20">
                <Magnetic>
                    <a href={project.url} target="_blank" rel="noopener noreferrer">
                        <Button size="lg" className="rounded-full px-10 h-16 text-lg bg-foreground text-background hover:bg-foreground/90 hover:scale-105 transition-all shadow-[0_0_60px_-15px_rgba(255,255,255,0.3)]">
