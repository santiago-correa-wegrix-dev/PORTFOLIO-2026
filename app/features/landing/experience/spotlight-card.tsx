            ...
            <div className="relative z-10 flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                    <div className="flex flex-col">
                        <h3 className="text-2xl font-bold text-foreground transition-colors duration-200">{t(`experience.jobs.${job.id}.role`)}</h3>
                        <span className="text-muted-foreground font-medium flex items-center gap-2">
                            <Briefcase className="w-4 h-4" /> {job.company}
                        </span>
                    </div>
                    <span className="font-mono text-sm text-muted-foreground border border-border px-3 py-1 rounded-full flex items-center gap-2 w-fit bg-background/50">
